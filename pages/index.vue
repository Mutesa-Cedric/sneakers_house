      ...
      <div class="flex flex-col space-y-6 lg:pl-12">
        ...
        <div class="flex flex-col space-y-2">
          <div class="flex space-x-4">
            ...
            <p v-if="currentProduct.discount" class="text-orange bg-orange-light text-sm px-2 flex items-center justify-center rounded-md font-bold">
        ...
        <div class="flex items-center space-x-5">
          ...
          <button @click="addToCart"
            class="bg-orange text-gray-blue-light flex items-center py-3 px-8 rounded-lg shadow-lg space-x-4 text-sm">
